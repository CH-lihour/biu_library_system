                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <input type="text" name="isbn" class="form-control" id="isbn"
                                        value="{{ old('isbn', $book->isbn) }}" placeholder="Enter is bn" />
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <select name="author_ids[]" id="author_ids" class="form-select js-select2"
                                        data-placeholder="Select authors" data-allow-clear="1" multiple>
                                        @foreach ($authors as $author)
                                            <option value="{{ $author->id }}" {{ (collect(old('author_ids', $book->authors->pluck('id')))->contains($author->id)) ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="col-md-12 form-group">
                                    ...
                                    <input type="number" name="pages" class="form-control" id="pages"
                                        value="{{ old('pages', $book->pages) }}" placeholder="Enter pages" />
