    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('member-plans.update', $memberPlan->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label for="name">Name <span class="text-danger">*</span></label>
                                <input type="text" name="name" class="form-control" id="name" value="{{ old('name', $memberPlan->name) }}"
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input type="number" name="loan_duration_days" class="form-control" id="loan_duration_days"
                                    value="{{ old('loan_duration_days', $memberPlan->loan_duration_days) }}" placeholder="Enter loan duration in days"
                                    min="1" step="1" />
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input type="number" name="fine_per_day" class="form-control" id="fine_per_day"
                                    value="{{ old('fine_per_day', $memberPlan->fine_per_day) }}" placeholder="Enter fine amount per day" step="0.01" />
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input type="number" name="discount_fee" class="form-control" id="discount_fee"
                                    value="{{ old('discount_fee', $memberPlan->discount_fee) }}" placeholder="Enter discount fee amount" step="0.01" />
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <textarea name="description" class="form-control" id="description"
                                    placeholder="Enter description">{{ old('description', $memberPlan->description) }}</textarea>
